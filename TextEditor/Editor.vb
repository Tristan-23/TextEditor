...
#Region "SAVE AND OPEN"
    ...
    Private Sub NeuToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles NeuToolStripMenuItem.Click
        If String.IsNullOrEmpty(TextBox.Text) Then
            ...
            Me.Text = "Editor"
        Else
            Select Case MessageBox.Show("Do you want to save your current text?", "Save?", MessageBoxButtons.YesNo)
...
#Region "DESIGN STUFF"
    ...
    Private Sub Klein300x150ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles Klein300x150ToolStripMenuItem.Click
        If Me.WindowState = FormWindowState.Maximized Then
            Me.WindowState = FormWindowState.Normal
        End If
    ...
    Private Sub BildschirmgrößeToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BildschirmgrößeToolStripMenuItem.Click
